...
- File sheet: open the right sheet for file-specific controls such as STEP tree/parameters, DXF thickness/bends, URDF/SRDF/SDF joints and metadata, plus the Display tab.
