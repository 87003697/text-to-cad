...
def discover_printer_serial(
    *,
    ...
    if not tls_verify:
        # Bambu printer firmware serves self-signed certificates. TLS verification is
        # independent of host policy: private hosts are the default boundary, while
        # --allow-nonprivate-host explicitly overrides that boundary.
