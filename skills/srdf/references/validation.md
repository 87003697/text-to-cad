...
1. **Bundled validator** (always): `python scripts/srdf path/to/robot.srdf`. Fix findings and re-run until clean; treat warnings as findings unless the ledger explains them.
