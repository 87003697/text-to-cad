...
class WorkspaceCliTests(unittest.TestCase):
    ...
    def measurement(
        ...
        *,
        ...
        summary = {
            "schema": "voxblame.measurement-summary/1",
            "coordinate_contract": "trellis2_canonical/1",
            "max_depth": 8,
            "step": step,
            "compare_to": compare_to,
            "artifact": f"voxblame/steps/{step:06d}/measurement.json",
            "canonical_reference": {
                "canonical_reference_sha256": self.reference_sha,
            ...
            "repair_targets": {
                "ordering_profile": "repair_target_partition/1",
                "total": 0,
                "returned": 0,
                "remaining": 0,
                "offset": 0,
        ...
        measurement = dict(summary)
        measurement["schema"] = "voxblame.measurement/1"
