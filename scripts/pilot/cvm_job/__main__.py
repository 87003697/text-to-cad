...
def _parser() -> argparse.ArgumentParser:
    ...
    provider_free.add_argument("scenario", choices=("installed-plugin", "agent-surface-mcp-injection", "agent-surface-mcp-direct-injection", "agent-surface-mcp-ephemeral-differential"))
