...
CADGEN_RUNTIME_DIR="$REPO_ROOT/skills/urdf/scripts/packages/cadgen"
...
Bundles the URDF skill runtime: the vendored cadgen Python package and the
...
if [ "$MODE" = "check" ]; then
  ...
  echo "Bundled skills/urdf/scripts/packages/cadgen"
