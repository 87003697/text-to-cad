 ...
 * serializer with no format-specific behaviour and lives in cadjs as shared runtime code.
 *
  ...
  for (const input of inputs) {
    ...
    const node = {
      ...
      extras: {
        ...
        // rather than the model's display name. A per-primitive `occurrenceId` still wins, and
