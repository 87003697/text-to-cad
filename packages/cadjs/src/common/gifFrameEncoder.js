// Transparent-GIF palette resolution for the retained cadjs headless snapshot
// entry. This is intentionally owned here now that the fork has retired the
// implicit CAD runtime; there is one consumer and no cross-package dependency.
//
