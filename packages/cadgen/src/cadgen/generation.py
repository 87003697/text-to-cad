...
from cadgen.file_metadata import text_to_cad_identity_metadata, write_dxf_text_to_cad_metadata
...
from cadgen.generation_status import generation_lock_path, track_generation_run
...
from cadgen.source_hash import (
    PythonSourceClosure,
    PythonSourceHash,
...
def run_script_generator(
    ...
    *,
    ...
    second build the generator's first-party deps (e.g. ``cadgen.assembly``) are
...
def _run_script_generator_inner(
    ...
    *,
    ...
    if generator_name == "gen_step":
        ...
        # infra like cadgen.glb). Record them now so a warm worker can evict precisely
...
def _assembly_provenance_manifest(
    ...
    *,
    ...
    from cadgen.glb_topology import step_topology_capabilities
...
def _generate_part_outputs(
    ...
    *,
    ...
    def component_package_job() -> dict[str, object]:
        ...
        # import would cycle.
        from cadgen.component_package import (
...
def _assembly_glb_package_current(spec: EntrySpec) -> bool:
    ...
    if spec.step_path is None:
        return False
    from cadgen.component_package import assembly_package_current
