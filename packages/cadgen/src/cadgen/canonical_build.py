...
from cadgen._internal.generation import _entry_spec_from_source, _run_script_generator_inner
from cadgen._internal.glb import export_canonical_measurement_glb_from_scene
from cadgen.cli_logging import CliLogger
from cadgen.step_export import write_xcaf_doc_step_file
from cadgen._internal.step_scene import load_step_scene, mesh_step_scene, scene_export_shape
...
_ACTIVE_SOURCE_POLICY: ContextVar[_SourceExecutionPolicy | None] = ContextVar(
    "cadgen_canonical_build_source_policy",
    default=None,
)
...
def _dependency_versions() -> list[dict[str, str]]:
    ...
    for name in ("cadgen", "build123d", "cadquery-ocp"):
        try:
