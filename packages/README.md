...
Small shared runtime helpers should still use this pattern: source lives once
under `packages/`, then each consuming skill gets its own generated
`scripts/packages/<package>` copy.
