...
COPPER_GOLD = (0.635, 0.380, 0.250, 1.0)    # salmon copper-gold bridges/plate
COPPER_GOLD_DEEP = (0.660, 0.420, 0.290, 1.0)  # striping groove shadow
GILT = (0.735, 0.650, 0.380, 1.0)           # pale champagne train wheels
BLUED = (0.110, 0.190, 0.520, 1.0)          # flame-blued screws + hands
RUBY = (0.600, 0.080, 0.220, 1.0)           # jewels (magenta ruby)
RUBY_BRIGHT = (0.780, 0.140, 0.320, 1.0)    # cap jewels
