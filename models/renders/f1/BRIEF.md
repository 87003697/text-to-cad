...
```
$PY skills/cad/scripts/gen models/renders/f1/parts/<YOUR_ENTRY>.step.py
```

Validate it:

```
$PY skills/cad/scripts/inspect refs models/renders/f1/parts/<YOUR_ENTRY>.step.py --facts --planes --positioning
```
...
import render
job = {
  "input": "models/renders/f1/parts/<YOUR_ENTRY>.step.py",
  "mode": "view",
