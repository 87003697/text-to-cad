...
/Users/jakefitzgerald/robots/text-to-cad/.venv/bin/python skills/cad/scripts/gen \
  models/renders/hypercar/.review/<mod>/<mod>.step.py
...
/Users/jakefitzgerald/robots/text-to-cad/.venv/bin/python \
  ...
  models/renders/hypercar/.review/<mod>/<mod>.step.py <stem> \
...
Write exactly one file: `models/renders/hypercar/hypercar_parts/<mod>.py`
