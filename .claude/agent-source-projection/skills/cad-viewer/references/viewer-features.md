...
- File sheet: open the right sheet for file-specific controls such as STEP tree/parameters and URDF/SRDF/SDF joints and metadata, plus the Display tab. Mesh files show a Measure tab for vertex-to-vertex distance. DXF drawings have material/bend controls.
