...
| SAI-011 | Colima/CVM typed evidence producers and 15-node orchestrator, including validation of SAI-005 external SBOM and browser artifacts | SAI-002, SAI-005, SAI-006, SAI-009 | independent fixed-catalog SPDX/license validation, candidate-bound identical-plan evidence, existing typed `sbom`/`browser-deny` nodes, canonical Verified root, then final lock |
